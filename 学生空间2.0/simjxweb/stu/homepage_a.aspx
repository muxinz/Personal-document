<%@ Page Title="" Language="C#" MasterPageFile="~/stu/LX.master" AutoEventWireup="true" CodeFile="homepage_a.aspx.cs" Inherits="stu_homepage_a" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    border-bottom-color: rgb(208, 214, 217);">
       ...
       <div style="float: left;">
        ...
        <a href="homepage.aspx" style="color: red;border-bottom: 2px solid #f01400;
                border-bottom-width: 2px;
                border-bottom-style: solid;
                border-bottom-color: rgb(240, 20, 0)">最近动态</a>
        </div> 
         <div style="float: left;margin-left:20px;">
         <a href="homepage_a.aspx" style="color: red;border-bottom: 2px solid #f01400;
                border-bottom-width: 2px;
                border-bottom-style: solid;
                border-bottom-color: rgb(240, 20, 0)">与我相关</a>
             </div>
        <div style="float: right;">
            <div style="position: relative;margin-right: 10px;">
                <span class="cursor: pointer">动态设置</span>
            </div>
            ...
            <div style="padding: 30px 0;padding-top: 30px;padding-right: 0px;padding-bottom: 30px;padding-left: 0px;position: relative;border-bottom: 1px solid #eff1f0;border-bottom-width: 1px; border-bottom-style: solid;border-bottom-color: rgb(239, 241, 240);">
                ...
                <div style="padding: 10px 0 22px;padding-top: 10px;padding-right: 0px;padding-bottom: 22px;padding-left: 0px;height: 21px;">
                    <span style="color: #f01400;">
                        <asp:Label ID="time" runat="server" Text='<%#Eval("create_time") %>'></asp:Label></span>
                    <span style="font-size: 14px;color: #787d82;"><asp:Label ID="obj_type" runat="server" Text='<%#Eval("obj_type") %>'></asp:Label></span>
                    <span style="font-size: 14px;color: #787d82;">
                       <a href="#" target=""> <asp:Label ID="tittle" runat="server" Text='<%#Eval("tittle") %>'></asp:Label></a></span>
                ...
                <div>
                    ...
                    <asp:Label ID="Label2" runat="server" Text='<%#Eval("memo") %>' Wid="200px"></asp:Label></div>
                </div>
            </div>
           </div>
                </ItemTemplate>
