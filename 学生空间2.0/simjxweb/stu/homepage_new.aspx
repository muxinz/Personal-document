<%@ Page Title="" Language="C#" MasterPageFile="~/stu/LX.master" AutoEventWireup="true" CodeFile="homepage_new.aspx.cs" Inherits="stu_homepage_new" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       ...
       <div style="float: left;"> 
        ...
        <div style="float: right;">
            <div style="position: relative;margin-right: 10px;">
                <span class="cursor: pointer"><a href="set_edit.aspx?stulogname=<%=a %>&stuschool=<%=b %>&sex=<%=c %>">编辑</a></span>
            </div>
    ...
    <div style="height:50px;">
            <div class="ff">电话：</div>
            <div class="gg"><asp:Label id="phone" runat="server" CssClass="kk" Font-Size="Medium" Text=""></asp:Label></div>
        </div>
      <br />
        <div style="height:50px;">
            <div class="ff">email：</div>
            <div class="gg"><asp:Label id="email" runat="server" CssClass="kk" Font-Size="Medium" Text=""></asp:Label></div>
        </div>
      <br />
    <div style="height:50px;">
            <div class="ff">个性签名：</div>
            <div class="gg"><asp:Label runat="server" CssClass="kk " Font-Size="Medium">好好学习，天天向上~
                            </asp:Label></div>
        </div>
