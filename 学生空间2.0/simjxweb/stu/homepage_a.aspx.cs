...
public partial class stu_homepage_a : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["userid"] != null)
        {
            ...
            pa[1] = new SqlParameter("@username", SqlDbType.VarChar, 8);
            DataSet ds = DbHelperSQL.ExecProc_Return("stuhomepage_aselect", pa);
